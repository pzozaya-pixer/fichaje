...
async function main() {
  ...
  // Ubicación de prueba: Puerta del Sol, Madrid
  ...
  console.log(`- Empleado: ${carlos.email}`);
  console.log(`- Empleado 2: ${ana.email}`);
  console.log(`- Consultor/Inspector: ${inspector.email}`);
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    exitDate.setHours(17, 58, 0, 0); // Salida a las 17:58
